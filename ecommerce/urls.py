...
sitemaps = {
    'kurs':KursSitemap(),
    'trgovina': ProductSitemap(),
    'izdavastvo': IzdavastvoSitemap(),
    'cart': OrderSitemap(),
...
urlpatterns += i18n_patterns(
    ...
    path("robots.txt",TemplateView.as_view(template_name="store/robots.txt", content_type="text/plain")),  #add the robots.txt file
