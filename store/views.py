...
#sending an email
        ...
        customerEmail =  render_to_string('store/customerEmail.html', {'user': request.user, 'email': request.user.email, 'grad': request.user.first_name, 'adresa': request.user.last_name, 'total': order.get_cart_total, 'ukupnoukorpi': order.get_cart_items, 'stvariukorpi': cartList})
